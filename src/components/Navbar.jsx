...
export default function Navbar() {
  ...
  return (
    <>
      <Header />
      <Box bg="gray.100" px={{ base: "5", md: "12" }} position="sticky" top="0">
        <Flex h={16} alignItems={"center"} justifyContent={"space-between"}>
          ...
          <HStack as={"nav"} spacing={5} display={{ base: "none", md: "flex" }}>
            ...
            <Link to="/mens">
              <Text _hover={{ textDecoration: "underline" }}>Men</Text>
            </Link>
            <Link to="/womens">
              <Text _hover={{ textDecoration: "underline" }}>Women</Text>
            </Link>
            <Link to="/shoes">
              <Text _hover={{ textDecoration: "underline" }}>Shoes</Text>
            </Link>
          </HStack>
